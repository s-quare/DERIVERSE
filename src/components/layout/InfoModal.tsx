...
import FadeIn from "../dashboard/FadeMotion";
...
export default function InfoModal() {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 bg-black min-h-svh overflow-y-auto no-scrollbar inset-0 z-100 flex items-center justify-center p-4 transition-all">
      <FadeIn activeKey={isOpen ? 'open' : 'closed'}>
          ...
          <div className="space-y-6 text-left">
            <div className="flex gap-4">
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                ...
                <span className="text-blue-400">Solflare</span> browser
                extension.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                ...
                Click the {`"Select Wallet"`} button in the top right and
                approve the request.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                ...
                to see your real trade history.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                ...
                You can switch to demo mode using the toggle on the dashboard if
                you want to see how it works without connecting a wallet.
              </p>
            </div>
          </div>
